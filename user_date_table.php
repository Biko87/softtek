...
<div class="todo">
  ...
  <div id="contenido">
  	<table style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px;">
        ...
        <th> <a href="logout.php"> <button type="button" class="btn btn-danger">Salir</button> </a> </th>
  		</thead>
      ...
      <?php
        ...
        while($fila=$resultado->fetch_assoc())
        {
          echo "<tr>";
            ...
            echo "<td><a href='modif.php?no=".$fila['no']."'> <button type='button' class='btn btn-success'>Modificar</button> </a></td>";
	...
	<div id="footer">
  		<img src="assets/images/images/images/swirl2.png" id="img2">
  	</div>
