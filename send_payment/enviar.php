...
$sql = "INSERT INTO customer_payment (nombre, email, cel, plan_plantilla, pago_nequi, img, mensaje, acepto_politica) VALUES ('$name', '$email', '$phone', '$theme', '$pago', '$img', '$message', '$politica')";
...
mysqli_close($conn);
    ...
    if ($_FILES['archivo']['error'] == 0) { //Valida si no hay errores
        $dir = "files/img/"; //Directorio de carga
        $tamanio = 500000; //Tamaño permitido en kb
                ...
                if (move_uploaded_file($_FILES['archivo']['tmp_name'], $ruta_carga)) {
                   // echo "El archivo se cargó correctamente";
                    ...
                    '<script>
                        ...
                        window.location.href="http://localhost/plantilla/miwebpuntocom/juniorp1.php";
                    </script>';
                }
                } else {
                echo 
                '<script>
                    alert("Archivo excede el tamaño permitido");
                    window.location.href="http://localhost/plantilla/miwebpuntocom/juniorp1.php";
                </script>';
            }
            } else {
...
try {
    ...
    $mail->Subject = 'Mi Web.com - Compra/Plantilla o Plan';
    $mail->Body    = "
<!DOCTYPE html>
...
<body width='100%' style='margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;'>
                ...
                <tr>
                    <td style='padding: 0 2.5em; text-align: center; padding-bottom: 3em;'>
                        <div class='text'>
                            ...
                            <h3><span style='font-size:30px;'>&#128073;</span>$name Ha comprado una plantilla o un plan </h3>
                        </div>
                    </td>
                </tr>
                <tr>
                      <td style='text-align: center;'>
                        <div class='text-author'>
                            ...
                            <h2>Estos son los datos de la compra de $name:</h2>
                        </div>
                      </td>
                    </tr>
            </table>
                  ...
                  <table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
                    <tr>
                      <td style='text-align: left; padding-right: 10px;'>
                        ...
                        <h3 class='heading'>Nombre de la Plantilla o Plan a cancelar:</h3>
                        <h3 class='heading'>Medio por el que pago:</h3>
                        <h3 class='heading'>Print del recibo:</h3>
                  ...
                  <table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
                    <tr>
                      <td style='text-align: left; padding-right: 10px;'>
                        ...
                        <h3 class='heading'>$pago</h3>
                        <h3 class='heading'>$img</h3>
    ...
    ;
    //Attachments
    $mail->AddAttachment($ruta_carga); //Adds an attachment from a path on the filesystem
    $mail->send();
   // echo "<script type='text/javascript'>window.location.href='http://localhost/miwebpuntocom/reveal/index.html';></script>";
    echo '<script>
        alert("¡Gracias! por tu compra, tu apoyo lo hace grande. Nos comunicaremos enseguida.");
        window.location.href="http://localhost/plantilla/miwebpuntocom/";
    </script>';
} catch (Exception $e) {
    echo '<script>
