                                    ...
                                    <li><a href="#themplate">Plantillas Junior</a>
                                        <ul>
                                            <li>
                                                ...
                                                <a href="juniorp3.php">Junior P2</a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <div class="row">
                                        ...
                                        <div class="swiper-container pro-single-top">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp1/1.png" alt="Plantilla Juniorp1"></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp1/2.png" alt="Plantilla Juniorp1"></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp1/3.png" alt="Plantilla Juniorp1"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="post-content">
                                        ...
                                        <h4>$15000</h4>
                                        <h6>Descripción</h6>
                                        <p>Plantilla sencilla donde tus clientes conoceran los productos o servicios que ofreces.</p>
                                    </div>
                                        <a href="junior/plantilla1/index.html" class="lab-btn" target="_blank"><span>Ver Plantilla</span></a>
        ...
        <section class="pricing-table padding-tb bg_size" style="background-image: url(assets/css/bg-image/pricing-bg.jpg)" id="combo">
            <div class="container">
                <div class="section-header">
                    <h2>Combo Juniro P1 Completo</h2>
                                                        ...
                                                        <h5 >Por favor seleccione el nombre de la plantilla o el Plan.</h5>
                                                            <label for="theme">Plantilla/Plan</label>
                                                              <select  id="disabledSelect" class="form-control form-control-lg" name="plan-plantilla" required>
                                                                ...
                                                                <option>Junior P1</option>
                                                                <option>Combo Junior P1 / Plan Básico</option>
                                                                <option>Combo Junior P1 / Plan Silver</option>
                                                                <option>Combo Junior P1 / Plan Gold</option>
                                                              </select>
                                                              <br>
