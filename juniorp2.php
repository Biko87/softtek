                                ...
                                <ul>
                                    ...
                                    <li><a href="">Conózcanos</a>
                                        <ul>
                                            ...
                                            <li><a href="#escribenos">Contáctenos</a></li>
                                            <li><a href="https://api.whatsapp.com/send?phone=573213323387&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20acerca%20de%20sus%20promociones%20de%20plantillas,%20planes%20y%20personalizados%20de%20p%C3%A1ginas%20web." target="_blank">Contáctenos Por Whatsapp</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="">Portafolio</a>
                            ...
                            <div class="row">
                                        ...
                                        <div class="swiper-container pro-single-top">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp2/1.png" alt="Plantilla Juniorp2"></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp2/2.png" alt="Plantilla Juniorp2"></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="single-thumb"><img src="assets/images/shop/portfolio/juniorp2/3.png" alt="Plantilla Juniorp2"></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="post-content">
                                        ...
                                        <h4>$20000</h4>
                                        <h6>Descripción</h6>
                                        <p>Plantilla sencilla con sección de portafolio para tus productos o servicios, sección de contáctenos, nosotros y equipo de trabajo.</p>
                                    </div>
                                        <a href="junior/plantilla2/index.html" class="lab-btn" target="_blank"><span>Ver Plantilla</span></a>
        ...
        <section class="pricing-table padding-tb bg_size" style="background-image: url(assets/css/bg-image/pricing-bg.jpg)" id="combo">
            <div class="container">
                <div class="section-header">
                    <h2>Combo Juniro P2 Completo</h2>
                                                        ...
                                                        <h5 >Por favor seleccione el nombre de la plantilla o el Plan.</h5>
                                                            <label for="theme">Plantilla/Plan</label>
                                                              <select  id="disabledSelect" class="form-control form-control-lg" name="plan-plantilla" required>
                                                                ...
                                                                <option>Junior P2</option>
                                                                <option>Combo Junior P2 / Plan Básico</option>
                                                                <option>Combo Junior P2 / Plan Silver</option>
                                                                <option>Combo Junior P2 / Plan Gold</option>
                                                              </select>
                                                              <br>
